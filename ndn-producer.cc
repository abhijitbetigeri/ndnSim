...
//Vasu: There is no need to set cache here at this place and we can use
// this place for any false setting of cachehit flag 
//  FwCacheHitTag cacheHitTag;
//  if (interest->GetPayload ()->PeekPacketTag (cacheHitTag))
//    {
//      data->GetPayload ()->RemovePacketTag (cacheHitTag);
//    }
